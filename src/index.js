...
━━━━━━━━━━━━━━━━━━━━━
💵 Сумма: ${fmt(sum)} ₽
🎁 Скидка 15% на первый заказ: \\-${fmt(discount)} ₽
...
function buildShortPrice() {
  const categories = [
    ...
    { label: 'Доставка FBO (паллетами)', keys: [
      'Доставка на Коледино (WB)',
      'Доставка на Электросталь (WB)',
      'Доставка на Подольск (WB)',
      'Доставка на Обухово',
      'Доставка на Чехов',
      'Доставка на Тулу (WB)',
      'Доставка на Рязань',
      'Доставка на Казань (WB)',
      'Доставка на Краснодар',
      'Доставка на Невинномысск',
      'Доставка на Екатеринбург',
    ] },
  ];
